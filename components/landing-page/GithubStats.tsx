...
export const GitHubStats = () => {
    return (
        <section
            id="github-stats"
            className="relative py-24 px-6 lg:px-12 overflow-hidden w-full"
        >
            ...
            <div className="max-w-7xl mx-auto text-center relative z-10">
                ...
                {/* GitHub Image Card */}
                <div className="mx-auto w-full max-w-3xl rounded-2xl bg-white/30 dark:bg-zinc-800/20 backdrop-blur-md shadow-md hover:shadow-lg transition-all duration-200 p-4 md:p-6">
                    <img
