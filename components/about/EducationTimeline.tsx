                            ...
                            education
                                ...
                                .map((edu) => (
                                    <li key={edu._id} className="relative">
                                        ...
                                        <div
                                            className="bg-white/30 dark:bg-zinc-800/20 backdrop-blur-md border border-white/10 dark:border-white/10 rounded-2xl p-6 shadow-md hover:shadow-lg transition-all">
                                            ...
                                            <p className="text-sm text-zinc-700 dark:text-zinc-300">
                                                Subject{edu.fieldsOfStudy.length > 1 ? "s" : ""}:{" "}
